 ...
 */
public class Student extends BasePojo implements java.io.Serializable {
    ...
    /** full constructor */
    public Student(String universityId, boolean active, CourseYear courseYear, Audit audit,
            Parent parent, Institute institute, Person person, Library library,
