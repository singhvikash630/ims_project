...
<h2><fmt:message key="designation.delete-designation-confirmation"/></h2>
  <table>
    <tr>
      <th>
          <fmt:message key="designation.designation-with-id-x-got-deleted-successfully">
              <fmt:param value="${designationId}"/>
          </fmt:message>
        </th>
    </tr>
  </table>
