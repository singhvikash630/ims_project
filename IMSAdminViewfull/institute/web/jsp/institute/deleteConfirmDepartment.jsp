...
<h2><fmt:message key="department.delete-department-confirmation"/></h2>
  <table>
    <tr>
      <th>
          <fmt:message key="department.department-with-id-x-got-deleted-successfully">
              <fmt:param value="${departmentId}"/>
          </fmt:message>
        </th>
    </tr>
  </table>
...
<table>
    <tr>
        <td>
            <br>
            <a href="<c:url value="/institute/findDepartment.do"/>">
                <fmt:message key="department.go-to-department-management"/></a>
        </td>
    </tr>
</table>
