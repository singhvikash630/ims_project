...
<h3><fmt:message key="department.update-department"/></h3>
...
<form:form modelAttribute="department">
    ...
    <table>
        <tr>
            <th>
                <fmt:message key="department.department-name"/> <form:errors path="name" cssClass="errors"/>
                <br/>
        ...
        <tr>
         ...
         <tr>
            <th>
                <fmt:message key="trustinstitute.instituteId"/> 
                <br/>
                <input type="text" name="instituteId" size="30" maxlength="80"/>
            </th>
        </tr>
        <tr>
            <td>
