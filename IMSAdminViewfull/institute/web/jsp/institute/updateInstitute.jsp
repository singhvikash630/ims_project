...
<h3><fmt:message key="institute.update-institute"/></h3>
...
<form:form modelAttribute="institute">
    ...
    <table>
        <tr>
            <th>
                <fmt:message key="institute.trust-id"/>
                <br/>
                <form:input path="trust.trustId" size="30" maxlength="80"/>
            </th>
        </tr>
        <tr>
            <th>
                <fmt:message key="institute.institute-master-id"/>
                <br/>
