...
<form:form modelAttribute="section">
    ...
    <table >
        <tr>
            <td>
                <a href="<c:url value="/course/addSection.do"/>"><fmt:message key="common.add"/></a>
            </td>
        </tr>
    ...
    <div id="advance" style="display:none">
        <table>
            ...
            <tr>
                <td><fmt:message key="section.section-name"/></td>

            </tr>
            <tr>
                <td><form:input path="sectionName" size="30"/></td>
    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th><fmt:message key="section.section-id"/></th>
                <th><fmt:message key="section.section-name"/></th>
        ...
        <tbody>
            <c:choose>
                ...
                <c:otherwise>
                    <c:forEach var="section" items="${selections}" varStatus="status">
                        <tr>
                            <td><intput type="checkbox" name="cb" id="${section.sectionId}"/></td>
                            <td><a href="<c:url value="/course/updateSection.do?sectionId=${section.sectionId}"/>">${section.sectionId}</a></td>
