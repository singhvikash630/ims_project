 ...
 */
@Controller
@RequestMapping("/authorization/findRoleService.do")
public class FindRoleServiceForm {

	private final RolesService rolesService;

	@Autowired
	public FindRoleServiceForm(RolesService rolesService) {
   ...
   /**     model.addAttribute("basicMode", "display:block");
	...
	public  String processSubmit(@RequestParam("searchMode") String searchMode,@RequestParam("basicSearchValue") String basicSearchValue ,
            @RequestParam("operator") String operator,RoleService roleService, BindingResult result, Model model) {
