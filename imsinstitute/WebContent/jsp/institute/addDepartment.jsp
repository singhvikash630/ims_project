...
<body>
    ...
    <input name="imsScreenName" value="value template/id" type="hidden">
    </form>
...
<body>
    ...
    <h2><fmt:message key="department.new-department"/></h2>
    ...
    <form:form modelAttribute="department">
        ...
        <table>
            <tr>
                <th>
                    <fmt:message key="department.name"/> <form:errors path="name" cssClass="errors"/>
                    <br/>
            ...
            <tr>
                <th>
                    <fmt:message key="department.description"/> <form:errors path="description" cssClass="errors"/>
                    <br/>
            ...
            <tr>
                <th>
                    <fmt:message key="trustinstitute.instutiteId"/>
                    <br/>
                    <input type="text" name="instutiteId" size="30" maxlength="80"/>
                </th>
            </tr>
            <tr>
                <td>
