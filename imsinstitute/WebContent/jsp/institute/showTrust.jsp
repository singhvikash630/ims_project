...
<h3><fmt:message key="institute.trust-information"/></h3>
...
<table>
    <tr>
        <td>
            <br>
            <a href="<c:url value="/institute/findTrust.do"/>"><fmt:message key="institute.go-to-trust-management"/></a>
        </td>
    </tr>
</table>
