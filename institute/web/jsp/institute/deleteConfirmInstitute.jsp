...
<h2><fmt:message key="institute.delete-institute-confirmation"/></h2>
  <table>
    <tr>
      <th>
          <fmt:message key="institute.institute-with-id-x-got-deleted-successfully">
              <fmt:param value="${instituteId}"/>
          </fmt:message>
        </th>
    </tr>
  </table>
