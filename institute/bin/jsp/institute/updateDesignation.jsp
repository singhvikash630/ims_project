...
<h3><fmt:message key="designation.update-designation"/></h3>
...
<form:form modelAttribute="designation">
    ...
    <table>
        <tr>
            <th>
                <fmt:message key="designation.name"/> <form:errors path="name" cssClass="errors"/>
                <br/>
                <form:input path="designationName" size="30" maxlength="80"/>
            </th>
        </tr>
        <tr>
            <th>
                <fmt:message key="designation.maxSalary"/> <form:errors path="maxSalary" cssClass="errors"/>
                <br/>
                <form:input path="maxsalary" size="30" maxlength="80"/>
            </th>
        </tr>
        <tr>
            <th>
                <fmt:message key="designation.minSalary"/> <form:errors path="minSalary" cssClass="errors"/>
                <br/>
                <form:input path="minSalary" size="30" maxlength="80"/>
            </th>
        </tr>
        <tr>
            <td>
