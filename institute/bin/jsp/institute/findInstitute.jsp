...
<form:form modelAttribute="institute">
    ...
    <table >
        <tr>
            <td>
                <a href="<c:url value="/institute/addInstitute.do"/>"><fmt:message key="common.add"/></a>
            </td>
        </tr>
    ...
    <div id="advance" style="display:none">
        <table>
            ...
            <tr>
                <td><fmt:message key="institute.trust-id"/></td>
                <td><fmt:message key="institute.institute-master-id"/></td>
            </tr>
            <tr>
                <td><input type="text" name="trustId" size="30"/></td>
                <td><input type="text" name="instituteMasterId" size="30"/></td>
    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th><fmt:message key="institute.trust-id"/></th>
                <th><fmt:message key="institute.institute-master-id"/></th>
                <th><fmt:message key="institute.status"/></th>         
            </tr>
        </thead>
        <tbody>
            <c:choose>
                ...
                <c:otherwise>
                    <c:forEach var="institute" items="${selections}" varStatus="status">
                        <tr>
                            <td><intput type="checkbox" name="cb" id="${institute.instituteId}"/></td>
                            <td><a href="<c:url value="/institute/updateInstitute.do?instituteId=${institute.instituteId}"/>">${institute.instituteId}</a></td>
