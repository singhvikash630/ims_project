...
<body>
    ...
    <div id="frame">
        ...
        <div id="rightPane">
           ...
           <div id="contentPane">
<h2 align="center"><fmt:message key="designation-designation-management"/></h2>
<br/>
<h3>
    <c:choose>
        <c:when test="${designation.new}"><fmt:message key="common.record-added-successfully"/></c:when>
        <c:otherwise><fmt:message key="common.record-updated-successfully"/></c:otherwise>
    </c:choose>
</h3>
<h3><fmt:message key="designation-designation-information"/></h3>

<table>
    <tr>
        <th align="left"><fmt:message key="designation-designation-designationId"/>:</th>
        <td>${designation-designationId}</td>
    </tr>
    <tr>
        <th align="left"><fmt:message key="designation-designation-name"/>:</th>
        <td>${designation.name}</td>
    </tr>
    
    <tr>
        <th align="left"><fmt:message key="designation.maxsalary"/>:</th>
        <td>${designation.maxSalary}</td>
    </tr>
    <tr>
        <th align="left"><fmt:message key="designation.minsalary"/>:</th>
        <td>${designation.minSalary}</td>
    </tr>
...
<table>
    <tr>
        <td>
            <br>
            <a href="<c:url value="/institute/findDesignation.do"/>"><fmt:message key="designation.go-to-designation-management"/></a>
        </td>
    </tr>
</table>
