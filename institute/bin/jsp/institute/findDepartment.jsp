...
<form:form modelAttribute="department">
    ...
    <table >
        <tr>
            <td>
                <a href="<c:url value="/institute/addDepartment.do"/>"><fmt:message key="common.add"/></a>
            </td>
        </tr>
    ...
    <div id="advance" style="display:none">
        <table>
            ...
            <tr>
                <td><fmt:message key="institute.name"/></td>
                <td><fmt:message key="institute.institute-id"/></td>
            </tr>
            <tr>
                <td><form:input path="name" size="30"/></td>
                <td><form:input path="institute.instituteId" size="30"/></td>
            </tr>
            <tr>
                <td>
                    <p class="submit"><input type="submit" value="<fmt:message key="common.search"/>"/></p>
    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th><fmt:message key="department.departmentId"/></th>
                <th><fmt:message key="department.name"/></th>
                <th><fmt:message key="trustInstitute-instituteID"/></th>
                <th><fmt:message key="department.description"/></th>
            </tr>
        </thead>
        <tbody>
            <c:choose>
                ...
                <c:otherwise>
                    <c:forEach var="department" items="${selections}" varStatus="status">
                        <tr>
                            <td><intput type="checkbox" name="cb" id="${department.departmentId}"/></td>
                            <td><a href="<c:url value="/institute/updateDepartment.do?departmentId=${department.departmentId}"/>">${department.departmentId}</a></td>
                            <td>${department.departmentId}</td>
                            <td>${department.name}</td>
                            <td>${department.trustInstituteId.instituteId}</td>
